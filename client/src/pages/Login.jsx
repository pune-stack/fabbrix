...
//console.log("login page checkpoint 1")
...
const Login = () => {
  ...
  console.log("login page checkpoint 4")
  ...
  console.log("login page checkpoint 5")
  const {
    register,
    handleSubmit,
    formState: { errors },
...
console.log("login page checkpoint 2")
export default Login;
console.log("login page checkpoint 3")
