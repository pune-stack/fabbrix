        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed pb-6 border-b-2 border-gray-800">
                You can save up to <span style={{ color: 'red', fontWeight: 'bold' }}>{product?.discount_max}%</span> on this product. Offer valid for the next 30 minutes. Hurry up!
              </p>
              ...
              <span className="title-font font-medium text-2xl">
                Original price: <span style={{ color: 'black', textDecoration: 'line-through', textDecorationColor: 'red' }}>
                  {formatCurrency(product?.price)}
                </span>
              </span>

              <span className="title-font font-medium text-2xl">
                  Discounted price: {formatCurrency(product?.discount_price)}
                </span>
